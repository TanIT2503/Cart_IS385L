<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GioHang.aspx.cs" Inherits="Cart.GioHang" %>
                        ...
                        <div class="card" style="width: 1250px">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex flex-row align-items-center">
                                                                <div>
                                                                    <asp:ImageButton ID="ImageButton1" class="img-fluid rounded-3" runat="server" CommandName="redirect" Width="65px" ImageUrl='<%# Eval("ANHSP") %>' />
                                                                </div>
                                                                <div class="ms-3">
                                                                    <h5>
                                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TENSP") %>' /></strong></h5>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="card bg-primary text-white rounded-3 pr-5" style="width: 420px; margin-left: 60px">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
